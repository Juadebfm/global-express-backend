...
const userResponseSchema = z.object({
  ...
  // Personal details
  gender: z.enum(['male', 'female', 'other']).nullable().describe('Gender'),
  dateOfBirth: z.string().nullable().describe('Date of birth (YYYY-MM-DD, encrypted at rest)'),
  emergencyContactName: z.string().nullable().describe('Emergency contact full name (encrypted at rest)'),
  emergencyContactPhone: z.string().nullable().describe('Emergency contact phone number (encrypted at rest)'),
  emergencyContactRelationship: z.string().nullable().describe('Relationship to emergency contact (e.g. Spouse, Parent)'),
  nationalId: z.string().nullable().describe('National ID number (encrypted at rest)'),
  // Account
...
\`\`\``,
      ...
      body: z.object({
        ...
        gender: z.enum(['male', 'female', 'other']).nullable().optional().describe('Gender'),
        dateOfBirth: z.string().nullable().optional().describe('Date of birth in YYYY-MM-DD format'),
        emergencyContactName: z.string().min(1).nullable().optional().describe('Emergency contact full name'),
        emergencyContactPhone: z.string().min(5).nullable().optional().describe('Emergency contact phone number'),
        emergencyContactRelationship: z.string().min(1).nullable().optional().describe('Relationship to emergency contact (e.g. Spouse, Parent)'),
        nationalId: z.string().min(1).nullable().optional().describe('National ID number'),
