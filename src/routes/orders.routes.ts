...
const orderResponseSchema = z.object({
  ...
  paymentDetailsSentAt: z.string().nullable().describe('ISO timestamp of the last time payment details were sent to the customer — null if never sent'),
...
**Example:** \`GET /api/v1/orders/track/GE-2024-AB12\``,
      ...
      response: {
        200: z.object({
          ...
          data: z.object({
            trackingNumber: z.string(),
            status: z.string().nullable().describe('Customer-facing mapped shipment status'),
            statusLabel: z.string().nullable().describe('Human-readable customer-facing status label'),
            origin: z.string(),
            destination: z.string(),
            ...
            cargoMetrics: z.object({
              packageCount: z.number().int().nonnegative(),
              totalWeightKg: z.string().describe('Final customer-visible total weight in kg'),
              totalCbm: z.string().describe('Final customer-visible total volume in CBM'),
            }),
      ...
      response: {
        200: z.object({
          ...
          data: z.object({
            ...
            status: z.string().nullable().describe('Customer-facing mapped shipment status'),
            statusLabel: z.string().nullable().describe('Human-readable customer-facing status label'),
            internalStatus: z.string().nullable().describe('Raw internal operational status'),
            internalStatusLabel: z.string().nullable().describe('Human-readable internal status label'),
            origin: z.string(),
            destination: z.string(),
            ...
            invoice: z.object({
              ...
              status: z.string(),
              shipmentPayer: z.string(),
              totalUsd: z.string(),
              totalNgn: z.string(),
              fxRateNgnPerUsd: z.string(),
            ...
            timeline: z.array(z.object({
              ...
              status: z.string().nullable(),
              statusLabel: z.string().nullable(),
              internalStatus: z.string().nullable().optional(),
              internalStatusLabel: z.string().nullable().optional(),
              timestamp: z.string(),
            })),
          }),
        }),
